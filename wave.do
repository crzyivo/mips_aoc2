...
add wave -noupdate -expand -group predictor /testbench/uut/b_predictor/PC4
add wave -noupdate -expand -group predictor /testbench/uut/b_predictor/branch_address_out
add wave -noupdate -expand -group predictor /testbench/uut/b_predictor/prediction_out
add wave -noupdate -expand -group predictor /testbench/uut/b_predictor/PC4_ID
add wave -noupdate -expand -group predictor /testbench/uut/b_predictor/prediction_in
add wave -noupdate -expand -group predictor /testbench/uut/b_predictor/branch_address_in
add wave -noupdate -expand -group predictor /testbench/uut/b_predictor/update
add wave -noupdate -expand -group predictor /testbench/uut/b_predictor/valid
add wave -noupdate -expand -group predictor /testbench/uut/b_predictor/prediction
add wave -noupdate -expand -group predictor /testbench/uut/b_predictor/tag
add wave -noupdate -expand -group predictor /testbench/uut/b_predictor/address
